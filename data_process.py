...
np.save('prepare_data/train_x.npy', train_x)
np.save('prepare_data/train_y.npy', train_y)
np.save('prepare_data/test_x.npy', test_x)
np.save('prepare_data/test_y.npy', test_y)
